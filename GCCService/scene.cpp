...
{
	return (r->isRenderable && !r->renderedLast && (r->transparency > 0 && r->transparency < 1) && !r->localTransparency);
}

bool localTransparencyRule(RBX::Render::Renderable* r)
{
	return (r->isRenderable && !r->renderedLast && (r->localTransparency > 0 && r->localTransparency < 1) && !r->transparency);
}

bool lastRenderRule(RBX::Render::Renderable* r)
{
	return r->renderedLast && r->transparency == 0 && r->localTransparency == 0;
}
