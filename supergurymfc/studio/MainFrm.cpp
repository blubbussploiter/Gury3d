...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndRunServiceTools.SetWindowText("Test");
	...
	SetWindowText("gury dev build boooooooo");
...
LRESULT CMainFrame::OnTabChange(WPARAM wp, LPARAM lp)
{
	...
	if (child && child->application)
	{
		RBX::AppManager::get()->setCurrentApplication(child->application);
...
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(RBX::AppManager::get()->getApplication() != 0);
}
